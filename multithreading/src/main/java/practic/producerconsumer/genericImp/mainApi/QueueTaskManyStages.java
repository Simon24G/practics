 ...
 */
public class QueueTaskManyStages {
    public static void launch(int numberProducers, int numberConsumers){
        ...
        Thread [] threads = {
                new Producers<TaskManyStages>(queue, rCreater, taskMarker, numberProducers),
                new Consumers<TaskManyStages>(queue, rExecute, numberConsumers)
        };
