...
public class TestBase {
    ...
    protected Trainee insertTrainee(String firstName, String lastName, int rating, Group group) throws DaoException {
    ...
    protected Subject insertSubject(String name) throws DaoException {
    ...
    protected Map<String, Subject> insertSubjects(String... subjectNames) throws DaoException {
    ...
    protected School insertSchool(String name, int year) throws DaoException {
    ...
    protected Group insertGroup(School school, String name, String room, int year) throws DaoException {
    ...
    protected List<Group> insertSchoolGroups(School school, int year, String[] names, String[] rooms) throws DaoException {
    ...
    protected Group insertGroupWithSubjects(School school, int year, String name, String room,
                                            Map<String, Subject> subjects, String[] subjectNames) throws DaoException {
    ...
    protected List<Group> insertSchoolGroupsWithSubjects(School school, int year, Map<String, Subject> subjects) throws DaoException {
    ...
    protected void insertBackendTrainees(Group groupBackEnd) throws DaoException {
    ...
    protected void insertFrontEndTrainees(Group groupFrontEnd) throws DaoException {
