...
public class TestFullSchoolOperations extends TestBase {
    ...
    @Test
    public void testInsertSchoolWithGroupsAndTrainees() throws DaoException {
    ...
    @Test
    public void testInsertSchoolWithGroupsAndSubjectsAndTrainees() throws DaoException {
        School school2018 = insertSchool("TTSchool", 2018);
    ...
    @Test
    public void testInsertSchoolWithGroupsAndSubjectsAndTraineesTransactional() throws DaoException {
        Map<String, Subject> subjects = insertSubjects("Linux", "MySQL", "NodeJS");
