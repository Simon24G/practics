...
public class TestTraineeOperations extends TestBase {
    ...
    @Test
    public void testInsertTrainee() throws DaoException {
    ...
    @Test
    public void testGetNonexistentTraineeById() throws DaoException {
        assertNull(traineeDao.getById(1234567));
    }

    @Test
    public void testGetTraineesFromEmptyTraineesTable() throws DaoException {
        assertEquals(0, traineeDao.getAll().size());
    }

    @Test(expected = RuntimeException.class)
    public void testInsertTraineeWithNullFirstName() throws DaoException {
        Trainee traineeIvanov = new Trainee(null, "Иванов", 5);
        traineeDao.insert(null, traineeIvanov);
    }

    @Test
    public void testUpdateTrainee() throws DaoException {
        Trainee traineeIvanov = insertTrainee("Иван", "Иванов", 5, null);
        Trainee traineeIvanovFromDB = traineeDao.getById(traineeIvanov.getId());
        assertEquals(traineeIvanov, traineeIvanovFromDB);
    ...
    @Test(expected = RuntimeException.class)
    public void testUpdateTraineeSetNullLastName() throws DaoException {
        Trainee traineeIvanov = insertTrainee("Иван", "Иванов", 5, null);
        Trainee traineeIvanovFromDB = traineeDao.getById(traineeIvanov.getId());
        assertEquals(traineeIvanov, traineeIvanovFromDB);
    ...
    @Test
    public void testDeleteTrainee() throws DaoException {
        Trainee traineeIvanov = insertTrainee("Иван", "Иванов", 5, null);
        Trainee traineeIvanovFromDB = traineeDao.getById(traineeIvanov.getId());
        assertEquals(traineeIvanov, traineeIvanovFromDB);
    ...
    @Test
    public void testInsertAndDeleteTwoTrainees() throws DaoException {
        Trainee traineeIvanov = insertTrainee("Иван", "Иванов", 5, null);
    ...
    @Test
    public void testIfCondition() throws DaoException {
        Trainee traineeIvanov = insertTrainee("Иван", "Иванов", 5, null);
    ...
    @Test
    public void testBatchInsertTrainees() throws DaoException {
